...
export const INCREMENT_VISITOR_COUNT = 'INCREMENT_VISITOR_COUNT';
export const UPDATE_TOTAL_PRICE = 'UPDATE_TOTAL_PRICE';
export const SET_ORDER_STATS = 'SET_ORDER_STATS';
export const SET_VISITOR_STATS = 'SET_VISITOR_STATS';
export const SET_PERIOD = 'SET_PERIOD';
export const LOAD_RECENT_ORDERS = 'LOAD_RECENT_ORDERS';
export const LOAD_BEST_SELLER = 'LOAD_BEST_SELLER';
