    ...
    <div className='flex flex-col'>
      ...
      <div className='p-[32px] tablet:py-[67px] w-full flex justify-center items-center'>
        <div className='flex gap-[48px] tablet:gap-[60px] flex-col items-center'>
          <div className='flex flex-col border-[2px] border-black items-center w-full tablet:w-3/5 laptop:w-1/2'>
            <div className='font-baz2 flex flex-col text-white bg-baz-black w-full items-center justify-center py-[24px]'>
              ...
              <div className='text-[#05E201] text-[16px] font-semibold tracking-[1.6px] tablet:text-[32px]  tablet:tracking-[3.2px] uppercase'>
                Confirmed
              </div>
            </div>
            <div className='flex flex-col py-[32px] gap-[24px] items-center'>
